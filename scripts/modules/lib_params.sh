#!/bin/bash
# =============================================================================
# lib_params.sh v12.10 - Qwen FP8 removed. All EAGLE MTP standardized. Blackwell optimized.
# =============================================================================

declare -A MODEL_PARAMS

# Format: IMAGE|HF_REPO|DEFAULT_TP|ENV_VARS|BASE_FLAGS
# Qwen3.6 - BF16 versions (Official SGLang EAGLE MTP config)
MODEL_PARAMS["qwen-27b-bf16"]="lmsysorg/sglang:latest|Qwen/Qwen3.6-27B|1|SGLANG_ENABLE_SPEC_V2=1|--reasoning-parser qwen3 --tool-call-parser qwen3_coder --speculative-algorithm EAGLE --speculative-num-steps 3 --speculative-eagle-topk 1 --speculative-num-draft-tokens 4"
MODEL_PARAMS["qwen-35b-a3b-bf16"]="lmsysorg/sglang:latest|Qwen/Qwen3.6-35B-A3B|1|SGLANG_ENABLE_SPEC_V2=1|--reasoning-parser qwen3 --tool-call-parser qwen3_coder --speculative-algorithm EAGLE --speculative-num-steps 3 --speculative-eagle-topk 1 --speculative-num-draft-tokens 4"

# Gemma 4 - BF16 versions (Gemma does NOT support FP8)
...
get_profile_description() {
    case $1 in
        ...
        qwen-35b-a3b-bf16) echo "Qwen3.6 35B-A3B BF16 (MoE) + EAGLE MTP" ;;
